        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="80px">
            ...
            <el-card class="box-card">
                ...
                <el-row>
                    ...
                    <el-col :xl='8' :lg='8' :md="12" :sm="24" :xs="24">
                        <el-form-item label="身份证" prop="id_card">
                            <el-input type="input" v-model="form.id_card"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                    ...
                    <el-col :xl='8' :lg='8' :md="12" :sm="24" :xs="24">
                        <el-form-item label="教育程度" prop="education">
                            <el-select v-model="form.education">
                                <el-option key="college" label="大学" value="college"></el-option>
                                <el-option key="highschool" label="高中" value="highschool"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                ...
                <el-row>
                    ...
                    <el-col :xl='8' :lg='8' :md="12" :sm="24" :xs="24">
                        <el-form-item label="手机电话" prop="mobile_phone">
                ...
                <el-row>
                    ...
                    <el-col :xl='8' :lg='8' :md="12" :sm="24" :xs="24">
                        <el-form-item label="所属行业" prop="trade">
                            <el-select placeholder="请选择" v-model="form.trade">
                                <el-option key="education" label="教育" value="education"></el-option>
